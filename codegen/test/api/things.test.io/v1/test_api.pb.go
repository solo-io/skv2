...
type PaintStatus struct {
	ObservedGeneration   uint32   `protobuf:"varint,1,opt,name=observedGeneration,proto3" json:"observedGeneration,omitempty"`
	PercentRemaining     uint32   `protobuf:"varint,2,opt,name=percentRemaining,proto3" json:"percentRemaining,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *PaintStatus) GetObservedGeneration() uint32 {
	if m != nil {
...
func (m *PaintStatus) GetPercentRemaining() uint32 {
	if m != nil {
...
var fileDescriptor_d0310f6dbe7aaf4b = []byte{
	...
	,
}
