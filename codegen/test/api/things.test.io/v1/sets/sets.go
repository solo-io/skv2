...
type PaintSet interface {
    ...
    Map() map[uint64]*things_test_io_v1.Paint
...
func (s *paintSet) Keys() sets.Set[uint64] {
	if s == nil {
...
func (s *paintSet) Map() map[uint64]*things_test_io_v1.Paint {
    if s == nil {
        return nil
    }

    newMap := map[uint64]*things_test_io_v1.Paint{}
...
func (s *paintMergedSet) Keys() sets.Set[uint64] {
	if s == nil {
		return sets.Set[uint64]{}
    }
...
func (s *paintMergedSet) Map() map[uint64]*things_test_io_v1.Paint {
    if s == nil {
        return nil
    }
...
type ClusterResourceSet interface {
    ...
    // Return the Set as a map of key to resource.
    Map() map[uint64]*things_test_io_v1.ClusterResource
    // Insert a resource into the set.
...
func (s *clusterResourceSet) Keys() sets.Set[uint64] {
	if s == nil {
		return sets.Set[uint64]{}
    }
    return s.Generic().Keys()
...
func (s *clusterResourceSet) Map() map[uint64]*things_test_io_v1.ClusterResource {
    if s == nil {
        return nil
    }

    newMap := map[uint64]*things_test_io_v1.ClusterResource{}
    for k, v := range s.Generic().Map() {
...
func (s *clusterResourceMergedSet) Keys() sets.Set[uint64] {
	if s == nil {
		return sets.Set[uint64]{}
    }
    toRet := sets.Set[uint64]{}
...
func (s *clusterResourceMergedSet) Map() map[uint64]*things_test_io_v1.ClusterResource {
    if s == nil {
        return nil
    }
