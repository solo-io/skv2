...
func makeGenericValidatingWebhookConfigurationSet(
	...
	genericSortFunc := func(toInsert, existing ezkube.ResourceId) bool {
		...
		if !ok {
			objToInsert = &admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration{
		...
		if !ok {
			objExisting = &admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration{
				ObjectMeta: v1.ObjectMeta{
	...
	genericEqualityFunc := func(a, b ezkube.ResourceId) bool {
		...
		if !ok {
			objA = &admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration{
				ObjectMeta: v1.ObjectMeta{
					Name:      a.GetName(),
		...
		if !ok {
			objB = &admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration{
				ObjectMeta: v1.ObjectMeta{
					Name:      b.GetName(),
