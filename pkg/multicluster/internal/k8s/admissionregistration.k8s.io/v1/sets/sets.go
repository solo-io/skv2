...
type ValidatingWebhookConfigurationSet interface {
    ...
    Map() map[uint64]*admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration
...
func (s *validatingWebhookConfigurationSet) Keys() sets.Set[uint64] {
	if s == nil {
...
func (s *validatingWebhookConfigurationSet) Map() map[uint64]*admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration {
    if s == nil {
        return nil
    }

    newMap := map[uint64]*admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration{}
...
func (s *validatingWebhookConfigurationMergedSet) Keys() sets.Set[uint64] {
	if s == nil {
		return sets.Set[uint64]{}
    }
...
func (s *validatingWebhookConfigurationMergedSet) Map() map[uint64]*admissionregistration_k8s_io_v1.ValidatingWebhookConfiguration {
    if s == nil {
        return nil
    }
