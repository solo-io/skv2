...
func (m *MockCustomResourceDefinitionWriter) UpsertCustomResourceDefinition(ctx context.Context, obj *v1.CustomResourceDefinition, transitionFuncs ...v1beta1.CustomResourceDefinitionTransitionFunction) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, obj}
...
// UpsertCustomResourceDefinition mocks base method
func (m *MockCustomResourceDefinitionClient) UpsertCustomResourceDefinition(ctx context.Context, obj *v1.CustomResourceDefinition, transitionFuncs ...v1beta1.CustomResourceDefinitionTransitionFunction) error {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, obj}
	for _, a := range transitionFuncs {
		varargs = append(varargs, a)
