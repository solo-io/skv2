...
func (m *MockCustomResourceDefinitionSet) GetSortFunc() func(interface{}, interface{}) bool {
	m.ctrl.T.Helper()
...
func (m *MockCustomResourceDefinitionSet) GetCompareFunc() func(interface{}, interface{}) int {
	m.ctrl.T.Helper()
...
func (mr *MockCustomResourceDefinitionSetMockRecorder) GetCompareFunc() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCompareFunc", reflect.TypeOf((*MockCustomResourceDefinitionSet)(nil).GetCompareFunc))
}
