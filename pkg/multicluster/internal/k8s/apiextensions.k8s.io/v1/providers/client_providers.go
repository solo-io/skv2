...
func CustomResourceDefinitionClientFromClientsetProvider(clients apiextensions_k8s_io_v1.Clientset) apiextensions_k8s_io_v1.CustomResourceDefinitionClient {
	return clients.CustomResourceDefinitions()
}

// Provider for CustomResourceDefinition Client from Client
func CustomResourceDefinitionClientProvider(client client.Client) apiextensions_k8s_io_v1.CustomResourceDefinitionClient {
	return apiextensions_k8s_io_v1.NewCustomResourceDefinitionClient(client)
}

type CustomResourceDefinitionClientFactory func(client client.Client) apiextensions_k8s_io_v1.CustomResourceDefinitionClient
...
type CustomResourceDefinitionClientFromConfigFactory func(cfg *rest.Config) (apiextensions_k8s_io_v1.CustomResourceDefinitionClient, error)
