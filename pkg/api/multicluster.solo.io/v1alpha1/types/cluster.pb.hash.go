...
func (m *KubernetesClusterSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("multicluster.solo.io.github.com/solo-io/skv2/pkg/api/multicluster.solo.io/v1alpha1/types.KubernetesClusterSpec")); err != nil {
		return 0, err
	}

	if _, err = hasher.Write([]byte(m.GetSecret())); err != nil {
		return 0, err
	}
...
func (m *KubernetesClusterStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("multicluster.solo.io.github.com/solo-io/skv2/pkg/api/multicluster.solo.io/v1alpha1/types.KubernetesClusterStatus")); err != nil {
		return 0, err
	}
