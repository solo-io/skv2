...
import (
	...
	pb2 "github.com/solo-io/skv2/pkg/jsonpb/testprotos/jsonpb_proto"
	pb3 "github.com/solo-io/skv2/pkg/jsonpb/testprotos/proto3_proto"
)
...
func TestAnyWithCustomResolver(t *testing.T) {
	...
	// Marshalling int64 should yield an integer, not string.
